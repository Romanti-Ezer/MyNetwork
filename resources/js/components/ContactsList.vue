    ...
    <div>
        ...
        <div v-else>
            <div v-if="contacts.length === 0">
                <p v-if="endpoint == '/api/birthdays'">No contacts with birthday this month.</p>
                <p v-else>No contacts yet. <router-link to="/contacts/create" class="text-blue-400">Get started ></router-link></p>
            </div>

            <div v-for="(contact, i) in contacts" v-bind:key="i">
