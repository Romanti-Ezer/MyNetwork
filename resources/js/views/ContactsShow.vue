    ...
    <div>
        ...
        <div v-else>
            <div class="flex justify-between">
                ...
                <div class="relative">
                    <router-link :to="'/contact/' + contact.contact_id + '/edit'" class="px-4 py-2 rounded text-sm text-green-400 border border-green-500 font-bold mr-2 hover:bg-green-500 hover:text-white">Edit</router-link>
                    <a href="javascript:void()" class="px-4 py-2 border border-red-500 rounded text-sm font-bold text-red-500 hover:bg-red-500 hover:text-white" @click="modal = !modal">Delete</a>
