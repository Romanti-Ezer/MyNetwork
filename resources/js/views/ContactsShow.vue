    ...
    <div>
        ...
        <div v-else>
            <div class="flex justify-between">
                ...
                <div class="relative">
                    <router-link :to="'/contacts/' + contact.contact_id + '/edit'" class="px-4 py-2 rounded text-sm text-green-400 border border-green-500 font-bold mr-2 hover:bg-green-500 hover:text-white">Edit</router-link>
                    <a href="javascript:void(0);" class="px-4 py-2 border border-red-500 rounded text-sm font-bold text-red-500 hover:bg-red-500 hover:text-white" @click="modal = !modal">Delete</a>

                    <div v-if="modal" class="absolute bg-blue-900 text-white rounded-lg z-20 p-8 w-64 right-0 mt-2 mr-2">
                        <p>Are you sure you want to delete this record?</p>

                        <div class="flex items-center mt-6 justify-endd">
